...
bool ModulePhysics3D::Start()
{
	...
	myWorld = new btDiscreteDynamicsWorld(dispatcher, pairCache, constraintSolver, collisionConfiguration);
	myWorld->setGravity(GRAVITY);
	//worldConfiguration->applyGravity();
	

	//TODO 4: Uncomment and link the debug Drawer with our newly created Physics world
	myWorld->setDebugDrawer(debug_draw);
