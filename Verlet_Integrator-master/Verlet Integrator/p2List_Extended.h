#ifndef __p2List_Extended_H__
#define __p2List_Extended_H__
...
public:
	...
	* const read operator access directly to a position in the list
	*/
	const p2List_Extended<tdata>& operator +=(const p2List_Extended<tdata>& other_list)
	{
	...
	*/
	...
	void InsertAfter(uint position, const p2List_Extended<tdata>& list)
	{
